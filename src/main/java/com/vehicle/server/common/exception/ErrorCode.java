...
public enum ErrorCode {
    ...
    VEHICLE_PLATE_EXISTS(HttpStatus.CONFLICT),
    VEHICLE_NOT_AVAILABLE(HttpStatus.CONFLICT),
    VEHICLE_HAS_ACTIVE_RESERVATIONS(HttpStatus.CONFLICT),
    ...
    RETURN_MILEAGE_LESS_THAN_PICKUP(HttpStatus.BAD_REQUEST),
    INTERNAL_ERROR(HttpStatus.INTERNAL_SERVER_ERROR),
    IMPORT_FORMAT_ERROR(HttpStatus.BAD_REQUEST),
    IMPORT_DATA_DUPLICATE(HttpStatus.CONFLICT);
